...
Route::get('/add-nurse', array('before' => 'old', 'uses' => 'NurseController@addnewnurse'));
...
/**********************************************SCHOOL SECTION *****************************************************/
Route::get('/add-school', array('before' => 'old', 'uses' => 'SchoolController@schoolsinsert'));
Route::get('/schools', array('before' => 'old', 'uses' => 'SchoolController@schoolslist'));


/********************************** ***************DOCTOR SECTION*************************************************/
Route::get('/add-doctor', array('before' => 'old', 'uses' => 'DoctorController@doctorsinsert'));
