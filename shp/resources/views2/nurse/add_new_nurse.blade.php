            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                      {!! Form::open(['role' => 'form', 'url' => 'add-nurse' ,'id' => 'add-nurse' ,'class' => 'form-horizontal  form-label-lefts','files' => true]) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Nurse Name">Nurse Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           {!! Form::text('nurse_name', null, ['required' =>'required','placeholder' => 'nurse name', 'id' => 'nurse-display-name' ,'class' => 'form-control col-md-7 col-xs-12 reqiured']) !!}
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                {!! Form::input('date', 'birth_date', null,array('required' =>'required','placeholder'=>'Birth date', 'id'=>"birth_date" , 'class'=>"form-control reqiured" )) !!}
                                </div>
                            </div>
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                      {!! Form::textarea('address', null, ['required' =>'required','placeholder' => 'address','id'=>'address', 'class' => 'form-control col-md-7 col-xs-12 reqiured']) !!}
                    </div>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         {!! Form::text('education', null, ['required' =>'required','placeholder' => 'Education qualification', 'id' => 'education' , 'class' => 'form-control col-md-7 col-xs-12 reqiured']) !!}
                        </div>
                      </div>
                      <div class="form-group ">
