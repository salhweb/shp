...
class GaugeChart extends Chart
{
	...
	public function orangeColor($orangeColor)
    {
        return $this->setStringOption(__FUNCTION__, $orangeColor);
    }
     ...
     * @return \Khill\Lavacharts\Charts\GaugeChart
     */
    public function orangeFrom($orangeFrom)
    {
        return $this->setIntOption(__FUNCTION__, $orangeFrom);
    }
     ...
     * @return \Khill\Lavacharts\Charts\GaugeChart
     */
    public function orangeTo($orangeTo)
    {
        return $this->setIntOption(__FUNCTION__, $orangeTo);
    }

	public function blueColor($blueColor)
    {
        return $this->setStringOption(__FUNCTION__, $blueColor);
    }
     ...
     * @return \Khill\Lavacharts\Charts\GaugeChart
     */
    public function blueFrom($blueFrom)
    {
        return $this->setIntOption(__FUNCTION__, $blueFrom);
    }
     ...
     * @return \Khill\Lavacharts\Charts\GaugeChart
     */
    public function blueTo($blueTo)
    {
        return $this->setIntOption(__FUNCTION__, $blueTo);
    }
